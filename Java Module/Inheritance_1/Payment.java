...
class CreditCardPayment extends Payment {
	...
	public CreditCardPayment(int payment_ID, double transaction_Amount, String payment_Date, String payer_Name,
			int cardNumber, int cvv, String cardTpye) {
...
class UPIPayment extends Payment {
	...
	public UPIPayment(int payment_ID, double transaction_Amount, String payment_Date, String payer_Name, int upi_ID,
			String appName, int utrNumber) {
		super(payment_ID, transaction_Amount, payment_Date, payer_Name);
		this.upi_ID = upi_ID;
...
class CashPayment extends Payment {
	...
	public CashPayment(int payment_ID, double transaction_Amount, String payment_Date, String payer_Name, int recieptNo,
			String cashierName, String currencyType) {
		super(payment_ID, transaction_Amount, payment_Date, payer_Name);
...
class RegisterPayment {
	public static void main(String[] args) {
		CreditCardPayment c1 = new CreditCardPayment(101, 2500.75, "12-11-2025", "Mohit", 987654321, 123, "Visa");
		c1.display();
		System.out.println("\n\n");
		UPIPayment u1 = new UPIPayment(102, 1500.50, "12-11-2025", "Mohit", 987654, "Google Pay", 123456789);
		u1.display();
		System.out.println("\n\n");
		CashPayment cs1 = new CashPayment(103, 2000.00, "12-11-2025", "Mohit", 501, "Krushna", "INR");
		cs1.display();
